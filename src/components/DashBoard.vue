<template>
    ...
    "> <a href="?page=index">
                    <img src="yuqing/image/shouye.png" style="  height: 1vw;
    margin: 0 0.1vw 0 0;" />
                    首页</a>
            </div>
            <div>舆情监测实时大数据平台</div>
    ...
    ">总量趋势 </div>
                        ...
                        <TotalMountChart ref="totalMountChart" :DarkMode="true" :planId="focusedPlan"/>
                    </div>
    ...
    padding: 0 0 0 0.5vw;
    "> 词云</div>
                        <WordCloudChart ref="wordCloudChart" :DarkMode="true" :planId="focusedPlan"/>
